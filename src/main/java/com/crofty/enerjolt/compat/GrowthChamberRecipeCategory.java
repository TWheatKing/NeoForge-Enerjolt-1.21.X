package com.crofty.enerjolt.compat;
...
import com.crofty.enerjolt.recipe.GrowthChamberRecipe;
...
public class GrowthChamberRecipeCategory implements IRecipeCategory<GrowthChamberRecipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(Enerjolt.MOD_ID, "growth_chamber");
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Enerjolt.MOD_ID,
