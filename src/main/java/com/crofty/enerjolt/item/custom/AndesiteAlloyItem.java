...
public class AndesiteAlloyItem extends Item {

    public AndesiteAlloyItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        if (isStrippedLog(blockState.getBlock())) {
            if (!level.isClientSide()) {
                ...
                level.setBlock(pos, ModBlocks.ANDESITE_CASING.get().defaultBlockState(), 3);
