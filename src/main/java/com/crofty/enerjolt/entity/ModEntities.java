package com.crofty.enerjolt.entity;

import com.crofty.enerjolt.Enerjolt;
import com.crofty.enerjolt.entity.custom.ChairEntity;
import com.crofty.enerjolt.entity.custom.GeckoEntity;
import com.crofty.enerjolt.entity.custom.TomahawkProjectileEntity;
...
public class ModEntities {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(BuiltInRegistries.ENTITY_TYPE, Enerjolt.MOD_ID);
